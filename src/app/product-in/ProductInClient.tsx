            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 bg-slate-50/80 p-3 rounded-xl border border-slate-200">
              ...
              <div className="flex flex-wrap items-center gap-2.5">
                ...
                <div className="flex items-center gap-2 bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-300 px-3 py-1.5 rounded-xl shadow-2xs">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <input
                      ...
                      placeholder="একক দর"
                      className="w-24 sm:w-28 pl-6 pr-2 py-1 text-xs sm:text-sm font-bold border border-amber-300 rounded-lg bg-white outline-none focus:ring-2 focus:ring-amber-500 font-mono text-gray-950 shadow-2xs"
                ...
                <button
                  ...
                  className="text-xs font-bold text-emerald-700 hover:text-emerald-800 hover:underline flex items-center gap-1 cursor-pointer bg-emerald-50 hover:bg-emerald-100 px-3 py-1.5 rounded-xl border border-emerald-300 transition-colors shadow-2xs"
                >
                  <Plus size={13} />
                  ...
                  <tr>
                    ...
                    <th className="p-3 w-40">
                      <div className="flex flex-col">
                        <span>দর / প্রতি একক (৳) <span className="text-red-400">*</span></span>
                        {masterPrice ? (
