    ...
    <div className="max-w-6xl mx-auto space-y-6 pt-4">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-gray-200">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-800">মহাজন ও কাস্টমার তালিকা <span className="text-lg font-normal text-gray-500">(Suppliers & Customers)</span></h1>
            <p className="text-sm text-gray-500 mt-1">আপনার ব্যবসার সকল মহাজন ও কাস্টমারদের প্রোফাইল ও বাকির হিসাব।</p>
          </div>
        </div>
