      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8 relative z-20">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            {/* Customer */}
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">কাস্টমার / গ্রাহক <span className="text-[10px] font-normal text-gray-400 uppercase">(Customer)</span> <span className="text-red-500">*</span></label>
              <select 
                value={clientId}
                onChange={(e) => setClientId(e.target.value)}
                className="w-full p-3 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-blue-500 font-medium"
                required
              >
            ...
            <div>
              ...
              <input 
                ...
                className="w-full p-3 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-blue-500 font-bold" 
                required
              />
            </div>
            ...
            <div>
              ...
              <div className="w-full p-3 border border-gray-300 rounded-lg bg-gray-50 font-bold text-blue-700">
